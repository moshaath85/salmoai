...
class Activity_logsService:
    ...
    async def create(self, data: Dict[str, Any]) -> Optional[Activity_logs]:
    ...
    async def get_by_id(self, obj_id: int) -> Optional[Activity_logs]:
        """Get activity_logs by ID"""
        try:
    ...
    async def get_list(
        ...
        """Get paginated list of activity_logss"""
        try:
    ...
    async def update(self, obj_id: int, update_data: Dict[str, Any]) -> Optional[Activity_logs]:
